          ...
          {/* <div className='w-1/3 absolute right-0 top-1/2 transform -translate-x-1/2 -translate-y-1/2 goadsgvedfevg h-1/3 -z-[1]'></div> */}
            <div  className='relative container mx-auto '>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-6 gap-[11px] sm:gap-[12px] md:gap-[13px] lg:gap-[14px] xl:gap-[15px] 2xl:gap-[16px]'>
                  ...
                  <div className="col-span-2 grid grid-rows-7 gap-[8px] w-full ml-3 sm:ml-0">
                    <div className='row-span-3 backgroiundignws px-[24px] sm:px-[32px] md:px-[36px] lg:px-[40px] xl:px-[48px] 2xl:px-[64px] py-[14px] sm:py-[15px] md:py-[16px] lg:py-[20px] xl:py-[24px] 2xl:py-[32px] flex items-center justify-center flex-col gap-[11px] sm:gap-[12px] md:gap-[13px] lg:gap-[14px] xl:gap-[15px] 2xl:gap-[16px] w-full'>
                    ...
                    <div className='row-span-3 w-full spacingsasdfsed px-[24px] sm:px-[32px] md:px-[36px] lg:px-[40px] xl:px-[48px] 2xl:px-[64px] py-[14px] sm:py-[15px] md:py-[16px] lg:py-[20px] xl:py-[24px] 2xl:py-[32px] flex items-center justify-center flex-col gap-[11px] sm:gap-[12px] md:gap-[13px] lg:gap-[14px] xl:gap-[15px] 2xl:gap-[16px]'>
                      <svg className='w-[32px] sm:w-[36px] md:w-[40px] lg:w-[48px] xl:w-[64px] 2xl:w-[71px]' viewBox="0 0 71 71" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect width="71" height="71" rx="35.5" fill="white" fill-opacity="0.1"/>
                      <rect x="0.5" y="0.5" width="70" height="70" rx="35" stroke="white" stroke-opacity="0.12"/>
